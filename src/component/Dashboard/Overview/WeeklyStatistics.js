				...
				<div className="display-in">
					<ul>
						<li>
							...
							<i className="fas fa-car user_icon_clr position-r w-15p p-5p fs-18 box-shadow statistics_car_icon float-right clr-red w-12p" />
						</li>
						<li>
							...
							<i className="fas fa-gamepad user_icon_clr  position-r w-15p p-5p fs-18 box-shadow w-12p statistics_game_icon float-right clr-yello" />
						</li>
						<li>
							...
							<i className="fas fa-graduation-cap user_icon_clr position-r w-15p p-5p fs-18 box-shadow w-12p statistics_study_icon float-right clr-violet" />
						</li>
					</ul>
				</div>
