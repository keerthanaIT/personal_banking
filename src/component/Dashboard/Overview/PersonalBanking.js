...
class PersonalBanking extends React.Component {
	render() {
		return (
			<div>
				<div className="personal-bank-box p-5p br-30px">
					<button type="button" className="float-right bg-white fs-14 p-2p card-button dark-gray-color font-b box-shadow position-r w-15p br-5p">
						+ Card
					</button>
